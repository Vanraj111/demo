...
class audiplay extends StatefulWidget {
  const audiplay({super.key});

  @override
  State<audiplay> createState() => _audiplayState();
}

class _audiplayState extends State<audiplay> {
  ...
  void initState() {
    ...
    // await player.setSource(AssetSource('audio/one piece.mp3'));
      await player.resume();
    });
  }
